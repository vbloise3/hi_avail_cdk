...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/cx-api", "1.21.1", __name__, "cx-api@1.21.1.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/cx-api.ContainerImageAssetMetadataEntry", jsii_struct_bases=[], name_mapping={'id': 'id', 'image_name_parameter': 'imageNameParameter', 'packaging': 'packaging', 'path': 'path', 'source_hash': 'sourceHash', 'build_args': 'buildArgs', 'file': 'file', 'repository_name': 'repositoryName', 'target': 'target'})
class ContainerImageAssetMetadataEntry():
    def __init__(self, *, id: str, image_name_parameter: str, packaging: str, path: str, source_hash: str, build_args: typing.Optional[typing.Mapping[str,str]]=None, file: typing.Optional[str]=None, repository_name: typing.Optional[str]=None, target: typing.Optional[str]=None):
        """
