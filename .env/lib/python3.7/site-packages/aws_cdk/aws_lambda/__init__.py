...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda", "1.21.1", __name__, "aws-lambda@1.21.1.jsii.tgz")
...
class IDestination(jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, scope: aws_cdk.core.Construct, fn: "IFunction") -> "DestinationConfig":
...
class _IDestinationProxy():
    ...
    def bind(self, scope: aws_cdk.core.Construct, fn: "IFunction") -> "DestinationConfig":
        ...
        :param fn: -
        """
        return jsii.invoke(self, "bind", [scope, fn])
