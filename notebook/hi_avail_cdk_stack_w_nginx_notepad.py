...
class HiAvailCdkStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        ssma_user_data.add_commands('sudo yum install -y https://s3.amazonaws.com/ec2-downloads-windows/SSMAgent/latest/linux_amd64/amazon-ssm-agent.rpm', 'sudo systemctl start amazon-ssm-agent')
        # install and start Nginx
        ssma_user_data.add_commands('sudo amazon-linux-extras install -y nginx1.12',
